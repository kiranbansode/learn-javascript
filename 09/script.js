...
console.log("Kiran Bansode".split(" "));

const [firstName, lastName] = "Kiran Bansode".split(" ");
...
capitalizeName("kiran ashok bansode");

// Padding
const message = "Go to gate 23!";
console.log(message.padStart(20, "+").padEnd(35, "+"));
console.log("Kiran".padStart(20, "+").padEnd(30, "+"));
...
console.log(maskCreditCard(434343434343434343434));
console.log(maskCreditCard("434343434343434343434"));
